...
def exAniClip(mayaFile='',openNewFile=1,
    ...
    for nameSpace in exNameSpace_desc:
        ...
        try:
            ...
            lprint(exNameSpace_desc.get(nameSpace),nameSpace)
            traceback.print_exc()
            continue
    ...
    try:
        ...
        description_abc_file=description.replace(".json","_abc_command_list.json")
        with codecs.open(description_abc_file , "w",encoding="utf8") as f:
            f.write(u"\n\n\n".join(abc_ex_job_list))
    except:
        traceback.print_exc()
        print(u"导出Abc错误")
        sys.exit()
