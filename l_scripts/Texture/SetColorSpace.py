...
class UI(QWidget):
    def __init__(self):
        ...
        self.srcColorSpaceWgtA.addItems(colorSpaceList+['Raw'])
        self.srcColorSpaceWgtA.setCurrentText('Raw')
        self.srcColorSpaceWgtA.setEditable(1)
        self.tgtColorSpaceWgtA.addItems(colorSpaceList)
        self.tgtColorSpaceWgtA.setEditable(1)
        self.tgtColorSpaceWgtA.setCurrentText('Utility - Raw')
        ...
        self.srcColorSpaceWgtB.setCurrentText('sRGB')
        self.tgtColorSpaceWgtB.addItems(colorSpaceList)
        self.tgtColorSpaceWgtB.setEditable(1)
        self.tgtColorSpaceWgtB.setCurrentText('Utility - sRGB - Texture')
    ...
    def setColorSpace(self,NodeType='Color|Grey'):
        ...
        for file in allFileNode:
            ...
            if NodeType=='Color':
                ...
                if not re.search('color',TexName,flags=re.I) and not isColorSpace:
